...
To run the model we use semantic_segmentation.py program from
 [[https://github.com/google-coral/pycoral  ](https://github.com/google-coral/pycoral/tree/master/examples)](https://github.com/google-coral/pycoral/tree/master/examples)
